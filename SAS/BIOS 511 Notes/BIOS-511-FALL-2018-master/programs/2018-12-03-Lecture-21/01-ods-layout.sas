...
%let outPath   = &root./BIOS-511-FALL-2018-master/programs/2018-12-03-lecture-21/output;        ** use TEXT SUBSTITUTION to define the OUTPATH macro variable;
...
/* Define a layout that is 7.00 inches high and 8.5 inches wide. 
   ...
   This is the section of the page that you will be dividing up and putting stuff on.
   If you end up putting stuff outside of this region, you will get a WARNING message and your output
   will look squished to fit.*/
ods layout start height=7.00in width=8.5in; 

/* Specifies the starting coordinates and dimensions of a particular region. The x and y coordinates start
counting from the top left of the page. Between two consecutive ODS REGION statements, SAS will try to put what
you indicate into the first ODS REGION. There is no guarantee that what you want to put into a region will
actually fit into that region (and SAS will tell you if it doesn't fit.) Regions do not have to be contiguous.*/

/*This region is 6 inches wide and does not have a specified height. It starts at the upper left corner of
your defined overall space, 0.5 inches down.*/
