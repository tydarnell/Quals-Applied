...
proc sgplot data = dm;
  styleattrs dataContrastColors=(red purple) datasymbols=(diamondFilled squareFilled); 
  scatter x=cnt_arm y=age / group=armcd jitter markerattrs=(size=5);
  yaxis label = 'Age (years)';
