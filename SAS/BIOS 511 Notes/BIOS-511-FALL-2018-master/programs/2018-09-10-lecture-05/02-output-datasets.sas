...
ods output OneWayFreqs = work.A; /*The name of the object (ODS object) you want to make into a dataset (on the left) = 
the name of the library you want to store your SAS dataset in and your SAS dataset name (on the right)*/
